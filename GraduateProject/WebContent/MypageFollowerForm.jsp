    ...
    <div class="container tim-container">
        <div id="extras">
                ...
                <div class="col-md-7 col-sm-12">
	                <table style="width:100%; height:250px; font-weight:bold; font-size:30px; align:center;">
						<tr style="text-align:center; height:34%;">
							...
							<td style="width:33%;"><a href="MypageFollowerForm.jsp?mypageid=<%=mypageid%>"><%= loginMemberId_followerCount %></a></td>
						...
						<tr style="text-align:center; height:33%;">
							...
							<td><a href="MypageFollowerForm.jsp?mypageid=<%=mypageid%>">팔로워</a></td>
            ...
            <%
    			...
    			//마이페이지 회원의 게시글수/팔로워수/팔로잉수 가져오는 부분
    			String sql_MyRecipe = "SELECT Follow_Sender FROM Follow WHERE Follow_Recipient = ?";
    			...
    			while(rs.next())
    			{
    				String Follow_Sender = rs.getString("Follow_Sender");
    				if(count % 4 == 0)
    				{
    			%>
    					</div>
    			...
    			%>
    				<div class="col-md-3 col-sm-6">
    					<a href="MypageForm.jsp?mypageid=<%=Follow_Sender %>">
