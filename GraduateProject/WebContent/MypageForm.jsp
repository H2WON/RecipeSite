    ...
    <div class="container tim-container">
        <div id="extras">
                ...
                <div class="col-md-7 col-sm-12">
	                <table style="width:100%; height:250px; font-weight:bold; font-size:30px; align:center;">
						<tr style="text-align:center; height:34%;">
							<td style="width:34%;"><a href="MypageForm.jsp?mypageid=<%=mypageid%>"><%= loginMemberId_postCount %></a></td>
							<td style="width:33%;"><a href="MypageFollowerForm.jsp?mypageid=<%=mypageid%>" style="color:black;" ><%= loginMemberId_followerCount %></a></td>
							<td style="padding-left:20px;"><a href="MypageFollowingForm.jsp?mypageid=<%=mypageid%>" style="color:black;"><%= loginMemberId_followingCount %></a></td>
						</tr>
						<tr style="text-align:center; height:33%;">
							<td><a href="MypageForm.jsp?mypageid=<%=mypageid%>">게시글</a></td>
							<td><a href="MypageFollowerForm.jsp?mypageid=<%=mypageid%>" style="color:black;">팔로워</a></td>
							<td><a href="MypageFollowingForm.jsp?mypageid=<%=mypageid%>" style="color:black;">팔로잉</a></td>
						</tr>
            ...
            <%
    			...
    			//마이페이지 회원의 게시글수/팔로워수/팔로잉수 가져오는 부분
    			String sql_MyRecipe = "SELECT Recipe_No,Recipe_ThumbnailChangeName FROM Recipe WHERE Recipe_Writer = ?";
    			...
    			%>
    				<div class="col-md-3 col-sm-6">
    					<a href="RecipeShow.jsp?recipeno=<%=Recipe_No %>">
    						<button class="btn btn-block btn-lg btn-info btn-simple" style="width:250px; height:180px;">
				 				<img src="\GraduateProject\RecipePhotoUpload\<%= Recipe_ThumbnailChangeName %>" class="img-rounded" width="160px" height="160px" />
				 			</button> 
				 		</a>
				 	</div>
    			<%
