...
<!-- 고정 메뉴 끝 -->   
	...
	<%
		int imgCountForRow = 0;	//레시피 이미지를 한 줄에 5개씩만 찍어주기 위한 count 변수
		String categoryName = "";
		...
		try {
			...
			String sql = "select * from TvRecipe where TvRecipe_TypeCategory = ? order by TvRecipe_No DESC";
					 		...
					 		<div class="col-md-2 col-sm-3">
					 			<a href="RecipeTVShow.jsp?recipeno=<%= TvRecipe_No %>">
					 				<button class="btn btn-block btn-lg btn-info btn-simple" style="width:250px; height:250px;">
						 				<img src="\GraduateProject\RecipePhotoUpload\<%= TvRecipe_ThumbnailChangeName %>" class="img-rounded" width="170px" height="140px"><p/>
						 				<%= TvRecipe_Title %>
					 				</button>
					 			</a>
					 		</div>
