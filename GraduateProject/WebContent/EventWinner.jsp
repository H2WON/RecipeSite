...
<%
		...
		try {
			...
			String RecipeSQL = "select * from Event where Event_Id = 7 or Event_Id = 8";
...
%>
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				<a href="EventShow.jsp?eventid=<%=Event_Id %>&eventtype=<%=eventtype%>" style="float:left;">
		 		<button class="btn btn-block btn-lg btn-info btn-simple">
		 			<h4 style=" clear:left;" ><font color="#4779d6" style="float:left;">[발표]&nbsp;</font><%= Event_Title%></h4>
		 			<div style="float:left;"><small>작성일자 : <%=Event_StartDate %></small></div>
		 		</button>
		 		</a>
			</div>
			<div class="col-md-2 col-sm-4">
		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				<ul class="pagination ct-blue"> 
				  <li class="active"><a href="EventList.jsp?sub=EventWinner">1</a></li>
				</ul>
			</div>
			<div class="col-md-2 col-sm-4">
			</div>
