...
<%
	...
	String TVRecipeCommentContent = request.getParameter("TVRecipeCommentContent");
...
<%
	...
	String sqlInsertRecipeComment = "INSERT INTO TVRecipeComment(TVRecipeComment_Content,TVRecipeComment_Date,TVRecipeComment_Writer,TVRecipe_No) values(?,?,?,?)";
	...
	try {
		...
		pstmt.setString(1,TVRecipeCommentContent);
